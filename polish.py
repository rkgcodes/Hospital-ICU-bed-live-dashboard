...
polish.title("Polish exercise")
polish.geometry("1400x800")

heading_font = ctk.CTkFont(size=18, weight="bold")
number_font = ctk.CTkFont(size=48, weight="bold")
header = ctk.CTkFrame(polish, corner_radius=15)
header.pack(pady=20)
...
title2 = ctk.CTkLabel(
    header,
    text="Last updated at 00:55 HRS"
)
title2.grid(
    row=1,
    column=0,
...
top_frame= ctk.CTkFrame(polish, corner_radius=15)
